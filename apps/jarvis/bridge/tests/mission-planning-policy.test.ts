...
describe('one-approval mission policy', () => {
  ...
  it.each([
    ...
    ['repository traversal', { repositoryPath: 'apps/jarvis/../private' }, EscalationReason.RepositoryExpansion],
    ['absolute repository path', { repositoryPath: '/apps/jarvis' }, EscalationReason.RepositoryExpansion],
    ['backslash repository path', { repositoryPath: 'apps\\jarvis' }, EscalationReason.RepositoryExpansion],
