...
import { JerichoRuntime, type GestureLabSnapshot } from './jericho-runtime';
...
export function GestureLab({ root }: { root: HTMLElement }) {
  ...
  const runtime = useRef<JerichoRuntime | undefined>(undefined);
