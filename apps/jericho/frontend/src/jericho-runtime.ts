...
export class JerichoRuntime {
  ...
  engage(): Promise<void> {
    if (this.disposed) return Promise.reject(new Error('Jericho runtime is disposed'));
  ...
  private assertNotDisposed(): void {
    if (this.disposed) throw new Error('Jericho runtime was disposed during engage');
  }
