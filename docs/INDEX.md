...
| [`../apps/jericho/README.md`](../apps/jericho/README.md) | Operator setup, configuration, gestures, and verification. | Any boot, configuration, UI, or gesture change. |
...
| Document | Status |
|---|---|
| `JERICHO-BUILD-PLAN.md` | Historical implementation plan; architecture and status claims may be stale. |
| `JERICHO-PARTY-TRICK-PLAN.md` | Historical visual/demo exploration; not a product or authority specification. |
...
| `JERICHO-RENAME-MIGRATION.md` | Product directory/persona rename record and allowlisted legacy persona notes. |
