# Jarvis Party Trick — Voice + Worker + Gestures

**Source**: https://x.com/ai_for_success/status/2071238528978341913 (IRIS project)
**Branch**: `masterblox/jarvis-party-trick-plan`
...
hand gestures on your webcam. Iron Man Jarvis. For a client demo it's "your agent,
...
- [ ] Launch script: `./jarvis --client <slug>` → fullscreen browser + bridge up
...
4. **Voice persona** — name + character for the demo agent (default: "Iris" since it's our design lane, or a neutral "Jarvis"-style codename).
