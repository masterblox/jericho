# Jericho Party Trick — Build Plan
...
> [`JERICHO-PARTY-TRICK-PLAN.md`](./JERICHO-PARTY-TRICK-PLAN.md)
>
> This doc is the **how**: file structure, stack, phased checklist, commands.

**App lives at:** `apps/jericho/` (new folder in this repo — extracts to its own repo later)
...
- [ ] `apps/jericho/` init: pnpm workspaces, tsconfig, vite, esbuild for bridge
...
**Phase 0 needs nothing from you** — no key, no fleet. I scaffold `apps/jericho/`, wire MediaPipe to the webcam, and you get a working hands-free HUD this session. Phase 1 lights up the moment the Gemini key lands.
